"""
Django settings for nammayatri project.
...
SECRET_KEY = 'django-insecure-n1*23vyg3n02eq$gf(p4)^ly-q_c2ylbaj0wh3pp2f%=q+#gv8'
...
AUTHENTICATION_BACKENDS = ['nammayatri.emailauth.EmailAuthBackend']
...
WSGI_APPLICATION = 'nammayatri.wsgi.application'
